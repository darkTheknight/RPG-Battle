...
# # Instantiate people
# player1 = Person("Valos", 3260, 132, 60, 34, player_spells, player_items)  # list items are magic items
# player2 = Person("Nicke", 4160, 188, 311, 34, player_spells, player_items)  # list items are magic items
# player3 = Person("Robot", 3089, 174, 288, 34, player_spells, player_items)  # list items are magic items
# 
# enemy1 = Person("Imp  ", 1250, 721, 215, 525, enemy_spells, [])  # enemy does not have magic items
# enemy2 = Person("Magus", 18250, 130, 560, 325, enemy_spells, [])
# enemy3 = Person("Imp  ", 1250, 130, 560, 325, enemy_spells, [])
# 
# players = [player1, player2, player3]
# enemies = [enemy1, enemy2, enemy3]
...
#     #             enemy = player.choose_target(enemies)
#     #
#     #             enemies[enemy].take_damage(item.prob)
#     #             # enemy.take_damage(item.prob)
#     #             print(Bcolors.FAIL + "\n" + item.name + " deals", str(item.prob),
#     #                   "points of damage to " + enemies[enemy].name + Bcolors.ENDC)
#     # for enemy in enemies:
